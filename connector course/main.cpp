...
#include <vector>//use vector for blink pattern
#include <inttypes.h>//for uintxx_t to printf scanf
#include "mbedtls/entropy_poll.h"
#include <sstream>
//libraries for connecor
#include "mbed-trace/mbed_trace.h"
#include "security.h"
#include "simpleclient.h"//todo

DigitalOut led(LED1);//LED 
Thread blinky_thread;//Thread for analyze the string and blink
Serial pc(USBTX, USBRX);//serial port 
I2C i2c(PTE25, PTE24);//used concerning the accelerometer
